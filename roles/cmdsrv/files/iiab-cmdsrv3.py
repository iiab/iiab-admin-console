...
SUPPLIED_PRESETS = {'en-school', 'es-school', 'fr-school', 'en-medical', 'en-school-256-base', 'en-starter', 'en-tech', 'test'}  # hardcoded list, needs to be updated if presets added
