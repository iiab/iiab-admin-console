...
def get_repo_item_defs_from_clone(clone_dir):
    # Get menu-def SHAs from a local git clone of js-menu-files.
    # No GitHub API or PAT needed — git ls-tree provides the same data.
