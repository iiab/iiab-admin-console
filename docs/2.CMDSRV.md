...
- /etc/uwsgi/apps-available/admin-console.ini - the Admin Console uWSGI app definition.
- /run/uwsgi/admin-console.socket - the systemd-activated uWSGI socket for the Admin Console.
